...
const state = {
    ...
    search: {
        ...
        results: [],
        page: 1,
        resPerPage: (0, _confgJs.RES_PER_PAGE)
    }
};
const loadRecipe = async (id)=>{
    try {
        const data = await (0, _helpersJs.getJSON)(`${(0, _confgJs.API_URL)}${id}`);
...
const loadSearchResults = async (query)=>{
    try {
        ...
        const data = await (0, _helpersJs.getJSON)(`${(0, _confgJs.API_URL)}?search=${query}`);
...
},{"regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./helpers.js":"hGI1E","./confg.js":"kjvRD"}],"hGI1E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kjvRD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewDefault.default) {
  ...
  <div class="recipe__details">
    ...
    <div class="recipe__info">
      ...
      <span class="recipe__info-data recipe__info-data--people">${this._data.sarvings}</span>
  ...
  <div class="recipe__directions">
    ...
    addHandlerRender(handler) {
        ...
        listners.map((lis)=>addEventListener(lis, handler));
    }
}
